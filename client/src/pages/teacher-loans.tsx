...
export default function TeacherLoans() {
  ...
  const tagInfo = {
    ...
    white: { label: "Etiqueta Branca (15 Dias)", color: "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300" },
  };
        ...
        {loansLoading ? (
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <Button onClick={() => setLocation("/teacher/books")} data-testid="button-search-books">
                Buscar Livros
              </Button>
            </CardContent>
          </Card>
            ...
            <Card className="mt-8">
              ...
              <CardContent className="space-y-3 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    <strong>Limite:</strong> Docentes podem emprestar até 4 livros simultaneamente.
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <AlertCircle className="h-4 w-4 text-muted-foreground mt-0.5" />
